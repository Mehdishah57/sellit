...
var signup = handleError_1.default(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error, _a, name, email, password, phone, user, newUser, salt, HASHED_PASS;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (user)
                    return [2 /*return*/, res.status(400).send("Email in use")];
